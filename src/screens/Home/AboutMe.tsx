...
export const AboutMe = () => {
  return (
    <section
      className="relative min-h-fit pt-12 pb-12 px-5 flex flex-col justify-between items-start overflow-hidden bg-gray-200"
      id="sobre-mim"
    >
      <div className="relative flex flex-col max-w-2xl justify-between items-start gap-5">
